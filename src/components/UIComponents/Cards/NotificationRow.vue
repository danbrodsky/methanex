<template>
  <div class="alert alert-info" style="line-height: 34px;">
    <div>
      ...
      <button type="submit" aria-hidden="true" v-on:click="dropRow()" style='margin-right:16px'
              class="btn btn-danger btn-sm btn-fill float-right">Decline
      </button>
      <button type="submit" aria-hidden="true" v-on:click="approve()" style='margin-right:16px'
