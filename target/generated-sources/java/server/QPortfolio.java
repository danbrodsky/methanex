...
public class QPortfolio extends EntityPathBase<Portfolio> {
    ...
    public final QResource businessOwner;
    ...
    public QPortfolio(Class<? extends Portfolio> type, PathMetadata metadata, PathInits inits) {
        ...
        this.businessOwner = inits.isInitialized("businessOwner") ? new QResource(forProperty("businessOwner"), inits.get("businessOwner")) : null;
